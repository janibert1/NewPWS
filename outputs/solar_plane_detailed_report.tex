...
\begin{itemize}
  ...
  \item Electrical power at best-endurance speed: \SI{17.95}{W}
  \item Electrical power at mission speed: \SI{21.41}{W}
...
\begin{itemize}
\item 10 km: 0.17 h, optimal speed 59.4 km/h, optimal start 11.67h
\item 25 km: 0.48 h, optimal speed 52.2 km/h, optimal start 11.17h
\item 50 km: 0.99 h, optimal speed 50.4 km/h, optimal start 11.17h
\item 75 km: 1.52 h, optimal speed 49.5 km/h, optimal start 10.83h
\item 100 km: 2.06 h, optimal speed 48.6 km/h, optimal start 10.50h
\item 150 km: 3.14 h, optimal speed 47.7 km/h, optimal start 10.17h
\item 200 km: 4.27 h, optimal speed 46.8 km/h, optimal start 9.83h
\item 250 km: 6.04 h, optimal speed 41.4 km/h, optimal start 9.00h
\end{itemize}

\section*{4. Battery Feasibility for Your Battery Bay}
\begin{itemize}
  \item 30-minute reserve target: \SI{11.22}{Wh} (minimum \SI{1011}{mAh} at 3S nominal).
  \item 20-minute reserve target: \SI{7.48}{Wh}.
  \item Theoretical max energy in bay (450--550 Wh/L): \SI{14.31}{Wh} to \SI{17.49}{Wh}.
  \item Daylight simulation minimum SOC: 0.0\%, final SOC: 0.0\%, first empty time: 8.50h.
\end{itemize}
...
\midrule
\endhead
Genasun GVB-8-Li-CV & Boost MPPT (complete controller) & 5-27V panel input, up to 8A output (114W at 14.2V) & Yes; 21S panel Vmp \textasciitilde{}11.6V is within boost range \\
Genasun GV-10-Li-CV & Buck MPPT (complete controller) & 10A output class; requires panel Vmp above battery charge voltage & No for robust margin with 3S Li-ion at 12.6V \\
TI BQ25798EVM & Buck-boost dev board (complete EVM) & Integrated MPPT function, advanced control and integration effort & Yes technically, but high development complexity \\
\bottomrule
\end{longtable}
